  ...
  describe "Logged Out" do
    ...
    describe "responding to GET show" do
      ...
      it "should expose the requested pkg as @pkg" do
        Pkg.should_receive(:find_by_name).with("acl").and_return(mock_pkg)
        get :show, :id => "acl"
  ...
  describe "Logged In" do
    ...
    describe "responding to POST create" do
      ...
      describe "with valid params" do
        ...
        it "should expose a newly created pkg as @pkg" do
          Pkg.should_receive(:new).with({'these' => 'params'}).
            and_return(mock_pkg(:save => true))
          @mock_pkg.should_receive("owner=").with(@current_user)
    ...
    describe "responding to PUT udpate" do
      ...
      describe "with valid params" do
        ...
        it "should update the requested pkg" do
          ...
          put :update, :id => "acl", :pkg => {:these => 'params'}
        end

        it "should expose the requested pkg as @pkg" do
          Pkg.stub!(:find_by_name).and_return(mock_pkg(:update_attributes => true))
          put :update, :id => "acl"
          assigns(:pkg).should equal(mock_pkg)
        end
      ...
      describe "with invalid params" do
        ...
        it "should expose the pkg as @pkg" do
          Pkg.stub!(:find_by_name).and_return(mock_pkg(:update_attributes => false))
          put :update, :id => "acl"
          assigns(:pkg).should equal(mock_pkg)
        end
    ...
    describe "responding to DELETE destroy" do
      ...
      it "should destroy the requested pkg" do
        Pkg.should_receive(:find_by_name).with("37").and_return(mock_pkg)
        mock_pkg.should_receive(:destroy)
        delete :destroy, :id => "37"
      end

      it "should redirect to the pkgs list" do
        Pkg.stub!(:find_by_name).and_return(mock_pkg(:destroy => true))
        delete :destroy, :id => "1"
